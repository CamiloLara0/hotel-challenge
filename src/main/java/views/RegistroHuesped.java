...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if(txtNreserva.toString()!=null && txtNombre.toString()!=null && txtApellido.toString()!=null && txtTelefono.toString()!=null && txtFechaN.getDate()!=null && txtNacionalidad.toString()!=null) {
					huespedActual();
					guardar = new CrudService();
					guardar.guardarDatos(huespedActual);
	...
	//Código que permite mover la ventana por la pantalla según la posición de "x" y "y"	
	 private void headerMousePressed(java.awt.event.MouseEvent evt) {
	    ...
	    public void reservaActual(Date ingreso, Date salida, int valor, String formaDePago) {
	        LocalDate fechaIngreso = toLocalDate(ingreso);
	        LocalDate fechaSalida = toLocalDate(salida);
	    	this.reservaActual = new Reserva(fechaIngreso, fechaSalida,valor,formaDePago);
	    }
	    
	    public LocalDate toLocalDate(Date fecha) {
	    	Instant instant = fecha.toInstant();
	        LocalDateTime localDateTime = instant.atZone(ZoneId.systemDefault()).toLocalDateTime();
	        LocalDate fechaLD = localDateTime.toLocalDate();
	    	return fechaLD;
	    }
	    
	    public void huespedActual() {
	    	String nombre = txtNombre.getText();
	    	String apellido = txtApellido.getText();
	    	LocalDate fechaNacimiento = toLocalDate(txtFechaN.getDate());
	    	String nacion = txtNacionalidad.getSelectedItem().toString();
	    	String telefono = txtTelefono.getText();
	    	int numReserva = Integer.parseInt(txtNreserva.getText());
	    	this.huespedActual = new Huesped(nombre, apellido,nacion,fechaNacimiento,telefono);
	    	this.reservaActual.setHuesped(huespedActual);
	    	this.reservaActual.setIdReserva(numReserva);
	    	this.huespedActual.setReservas(reservaActual);
