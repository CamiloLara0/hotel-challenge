...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
			...
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if(ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
					if(valorReserva()<0) {
						...
						JOptionPane.showMessageDialog(null, "la fecha de salida debe ser posterior a la entrada");
					}else {
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			private void guardarDatos() {
				...
				int valorReserva = valorReserva();
				RegistroHuesped registro = new RegistroHuesped();
				registro.setVisible(true);
				registro.reservaActual(fechaEntrada, fechaSalida, valorReserva, formaPago);
				dispose();
	...
	public int valorReserva() {
		...
		cal1.setTime(txtFechaEntrada.getDate());
		cal2.setTime(txtFechaSalida.getDate());
